...
- (NSData *)zipImage{
    ...
    return [self zipImageWithSize:150];
    
}
- (NSData *)zipImageWithSize:(CGFloat)size{
    ...
    if (self.size.width>DEVICEWidth *2) {
    ...
    return [newimage compressImageData:size];
}
-(NSData *)compressImageData:(CGFloat)size
{
    ...
    while ([imgData length] > size * 1024 *8) {
